    ...
    handleControlClick(e) {
        ...
        if (e.target.value === "Up") {
            ...
            const resuestOptions = {
                method: 'PUT',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ exp_id: 1, action: "v3", value: "1" })
            };
            fetch('/api/exp', resuestOptions)
                .then(response => response.json())
                .then(data => console.log(data));
        ...
        return (
            <>
                <div class="container d-flex justify-content-center align-items-center mh-100 bg-sucess">
                    ...
                    <div class="mw-100 p-3">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/dQw4w9WgXcQ?si=SiXViXzuqsNumNzw&autoplay=1" title="YouTube video player" frameborder="0" allow="autoplay; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                    </div>
                    <div class="mw-100 p-3">
